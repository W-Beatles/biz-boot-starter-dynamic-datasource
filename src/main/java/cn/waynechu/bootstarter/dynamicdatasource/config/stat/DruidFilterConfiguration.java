...
public class DruidFilterConfiguration {
    ...
    private static final String FILTER_ENCODING_PREFIX = "spring.datasource.dynamic.druid.filter.encoding";
    private static final String FILTER_SLF4J_PREFIX = "spring.datasource.dynamic.druid.filter.slf4j";
    private static final String FILTER_LOG4J_PREFIX = "spring.datasource.dynamic.druid.filter.log4j";
    private static final String FILTER_LOG4J2_PREFIX = "spring.datasource.dynamic.druid.filter.log4j2";
